...
public class mybatisJump extends AnAction {
    ...
    private static Pattern PATTERN_MAPPER_NAMESPACE = Pattern.compile("<mapper\\s+namespace=\"([\\.\\w]+)\".*>");
    private static String  IGNORE_STRS_REGEX        = "ServiceImpl|DaoImpl|Service|Dao";  // 預設應該為空; 最好是可以再設定裡修改
